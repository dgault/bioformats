...
public class ColorizerComposite extends ImagePlus {
	ImagePlus toClose;
	...
	public ColorizerComposite(ImagePlus imp) {
		this(imp, COLOR);
	}
	
	public ColorizerComposite(ImagePlus imp, int mode) {
		toClose = imp;
  ...
  public void show(String message) {
    ...
    // see ticket #12267
    int cSize = toClose.getNChannels();
